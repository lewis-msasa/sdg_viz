...
// node_modules/tableau-api/index.js
var require_tableau_api = __commonJS({
  "node_modules/tableau-api/index.js"(exports, module) {
    var tableauSoftware = {};
    (function() {
      var global = {};
      (function(global2) {
        ...
        ss2.initAssembly = function assembly(obj, name, res) {
          res = res || {};
          obj.name = name;
        ...
        ss2.getAssemblies = function ss$getAssemblies() {
          return Object.keys(ss2.__assemblies).map(function(n) {
            return ss2.__assemblies[n];
          });
        };
        ss2.isNullOrUndefined = function ss$isNullOrUndefined(o) {
          return o === null || o === void 0;
        };
        ss2.isValue = function ss$isValue(o) {
          return o !== null && o !== void 0;
        };
        ss2.referenceEquals = function ss$referenceEquals(a, b) {
          return ss2.isValue(a) ? a === b : !ss2.isValue(b);
        };
        ss2.mkdict = function ss$mkdict() {
        ...
        ss2.clone = function ss$clone(t, o) {
          return o ? t.$clone(o) : o;
        };
        ss2.coalesce = function ss$coalesce(a, b) {
          return ss2.isValue(a) ? a : b;
        };
        ss2.isDate = function ss$isDate(obj) {
          return Object.prototype.toString.call(obj) === "[object Date]";
        };
        ss2.isArray = function ss$isArray(obj) {
          return Object.prototype.toString.call(obj) === "[object Array]";
        };
        ss2.isTypedArrayType = function ss$isTypedArrayType(type) {
          return [
            "Float32Array",
            "Float64Array",
            "Int8Array",
            ...
            "Uint32Array",
            "Uint8ClampedArray"
          ].indexOf(ss2.getTypeFullName(type)) >= 0;
        };
        ss2.isArrayOrTypedArray = function ss$isArray(obj) {
          return ss2.isArray(obj) || ss2.isTypedArrayType(ss2.getInstanceType(obj));
        };
        ss2.getHashCode = function ss$getHashCode(obj) {
          if (!ss2.isValue(obj))
            ...
            for (var i = 0; i < obj.length; i++)
              res = res * 31 + obj.charCodeAt(i) & 4294967295;
            return res;
          } else if (ss2.isDate(obj)) {
            return obj.valueOf() & 4294967295;
          } else {
            return ss2.defaultHashCode(obj);
          }
        };
        ss2.defaultHashCode = function ss$defaultHashCode(obj) {
          return obj.$__hashCode__ || (obj.$__hashCode__ = Math.random() * 4294967296 | 0);
        };
        ss2.equals = function ss$equals(a, b) {
          if (!ss2.isValue(a)) throw new ss_NullReferenceException("Object is null");
          else if (a !== ss2 && typeof a.equals === "function") return a.equals(b);
          if (ss2.isDate(a) && ss2.isDate(b)) return a.valueOf() === b.valueOf();
          else if (typeof a === "function" && typeof b === "function")
            return ss2.delegateEquals(a, b);
          else if (ss2.isNullOrUndefined(a) && ss2.isNullOrUndefined(b)) return true;
          else return a === b;
        };
        ss2.compare = function ss$compare(a, b) {
          if (!ss2.isValue(a)) throw new ss_NullReferenceException("Object is null");
          else if (typeof a === "number" || typeof a === "string" || typeof a === "boolean")
            return a < b ? -1 : a > b ? 1 : 0;
          else if (ss2.isDate(a)) return ss2.compare(a.valueOf(), b.valueOf());
          else return a.compareTo(b);
        };
        ss2.equalsT = function ss$equalsT(a, b) {
          if (!ss2.isValue(a)) throw new ss_NullReferenceException("Object is null");
          else if (typeof a === "number" || typeof a === "string" || typeof a === "boolean")
            return a === b;
          else if (ss2.isDate(a)) return a.valueOf() === b.valueOf();
          else return a.equalsT(b);
        };
        ss2.staticEquals = function ss$staticEquals(a, b) {
          if (!ss2.isValue(a)) return !ss2.isValue(b);
          else return ss2.isValue(b) ? ss2.equals(a, b) : false;
        };
        ss2.shallowCopy = function ss$shallowCopy(source, target) {
        ...
        ss2.isLower = function ss$isLower(c) {
          var s = String.fromCharCode(c);
          return s === s.toLowerCase() && s !== s.toUpperCase();
        };
        ss2.isUpper = function ss$isUpper(c) {
          var s = String.fromCharCode(c);
          return s !== s.toLowerCase() && s === s.toUpperCase();
        };
        ...
        ss2.clearKeys = function ss$clearKeys(d) {
          for (var n in d) {
            if (d.hasOwnProperty(n)) delete d[n];
          }
        };
        ss2.keyExists = function ss$keyExists(d, key) {
          return d[key] !== void 0;
        };
        if (!Object.keys) {
        ...
        ss2.getKeyCount = function ss$getKeyCount(d) {
          return Object.keys(d).length;
        };
        ss2.__genericCache = {};
        ss2._makeGenericTypeName = function ss$_makeGenericTypeName(genericType, typeArguments) {
          var result = genericType.__typeName;
          for (var i = 0; i < typeArguments.length; i++)
            result += (i === 0 ? "[" : ",") + "[" + ss2.getTypeQName(typeArguments[i]) + "]";
          result += "]";
          return result;
        };
        ss2.makeGenericType = function ss$makeGenericType(genericType, typeArguments) {
          var name = ss2._makeGenericTypeName(genericType, typeArguments);
          return ss2.__genericCache[name] || genericType.apply(null, typeArguments);
        };
        ss2.registerGenericClassInstance = function ss$registerGenericClassInstance(instance, genericType, typeArguments, members, baseType, interfaceTypes) {
          var name = ss2._makeGenericTypeName(genericType, typeArguments);
          ss2.__genericCache[name] = instance;
        ...
        ss2.registerGenericInterfaceInstance = function ss$registerGenericInterfaceInstance(instance, genericType, typeArguments, members, baseInterfaces) {
          var name = ss2._makeGenericTypeName(genericType, typeArguments);
          ss2.__genericCache[name] = instance;
          instance.__typeName = name;
          instance.__genericTypeDefinition = genericType;
        ...
        ss2.isGenericTypeDefinition = function ss$isGenericTypeDefinition(type) {
          return type.__isGenericTypeDefinition || false;
        };
        ss2.getGenericTypeDefinition = function ss$getGenericTypeDefinition(type) {
          return type.__genericTypeDefinition || null;
        };
        ss2.getGenericParameterCount = function ss$getGenericParameterCount(type) {
          return type.__typeArgumentCount || 0;
        };
        ss2.getGenericArguments = function ss$getGenericArguments(type) {
          return type.__typeArguments || null;
        };
        ss2.setMetadata = function ss$_setMetadata(type, metadata) {
          if (metadata.members) {
          ...
          if (metadata.variance) {
            type.isAssignableFrom = function(source) {
              var check = function(target, type2) {
                if (type2.__genericTypeDefinition === target.__genericTypeDefinition && type2.__typeArguments.length == target.__typeArguments.length) {
                  for (var i3 = 0; i3 < target.__typeArguments.length; i3++) {
                    ...
                    switch (v) {
                      case 1:
                        if (!ss2.isAssignableFrom(t, s)) return false;
                        break;
                      case 2:
                        if (!ss2.isAssignableFrom(s, t)) return false;
                        break;
                      default:
                        if (s !== t) return false;
                    }
              ...
              for (var i2 = 0; i2 < ifs.length; i2++) {
                if (ifs[i2] === this || check(this, ifs[i2])) return true;
              }
              return false;
            };
          }
        ...
        ss2.initClass = function ss$initClass(ctor, asm, members, baseType, interfaces) {
          ctor.__class = true;
          ctor.__assembly = asm;
        ...
        ss2.initGenericClass = function ss$initGenericClass(ctor, asm, typeArgumentCount) {
          ctor.__class = true;
          ctor.__assembly = asm;
        ...
        ss2.initInterface = function ss$initInterface(ctor, asm, members, baseInterfaces) {
        ...
        ss2.initGenericInterface = function ss$initGenericClass(ctor, asm, typeArgumentCount) {
          ctor.__interface = true;
          ctor.__assembly = asm;
          asm.__types[ctor.__typeName] = ctor;
          ctor.__typeArgumentCount = typeArgumentCount;
        ...
        ss2.initEnum = function ss$initEnum(ctor, asm, members, namedValues) {
          ctor.__enum = true;
          ctor.__assembly = asm;
          asm.__types[ctor.__typeName] = ctor;
          ss2.shallowCopy(members, ctor.prototype);
        ...
        ss2.getBaseType = function ss$getBaseType(type) {
        ...
        ss2.getTypeFullName = function ss$getTypeFullName(type) {
          return type.__typeName || type.name || (type.toString().match(/^\s*function\s*([^\s(]+)/) || [])[1] || "Object";
        };
        ss2.getTypeQName = function ss$getTypeFullName(type) {
          return ss2.getTypeFullName(type) + (type.__assembly ? ", " + type.__assembly.name : "");
        };
        ss2.getTypeName = function ss$getTypeName(type) {
        ...
        ss2.getTypeNamespace = function ss$getTypeNamespace(type) {
          var fullName = ss2.getTypeFullName(type);
          var bIndex = fullName.indexOf("[");
          var nsIndex = fullName.lastIndexOf(
            ".",
        ...
        ss2.getTypeAssembly = function ss$getTypeAssembly(type) {
          if (ss2.contains([Date, Number, Boolean, String, Function, Array], type))
            return ss2;
          else return type.__assembly || null;
        };
        ss2._getAssemblyType = function ss$_getAssemblyType(asm, name) {
          var result = [];
          if (asm.__types) {
            ...
            for (var i = 0; i < a.length; i++) {
              asm = asm[a[i]];
              if (!ss2.isValue(asm)) return null;
            }
            if (typeof asm !== "function") return null;
            return asm;
          }
        };
        ss2.getAssemblyTypes = function ss$getAssemblyTypes(asm) {
          var result = [];
          if (asm.__types) {
        ...
        ss2.createAssemblyInstance = function ss$createAssemblyInstance(asm, typeName) {
          var t = ss2.getType(typeName, asm);
          return t ? ss2.createInstance(t) : null;
        };
        ss2.getInterfaces = function ss$getInterfaces(type) {
        ...
        ss2.isInstanceOfType = function ss$isInstanceOfType(instance, type) {
          if (ss2.isNullOrUndefined(instance)) return false;
          if (typeof type.isInstanceOfType === "function")
            return type.isInstanceOfType(instance);
          return ss2.isAssignableFrom(type, ss2.getInstanceType(instance));
        };
        ss2.isAssignableFrom = function ss$isAssignableFrom(target, type) {
          return target === type || typeof target.isAssignableFrom === "function" && target.isAssignableFrom(type) || type.prototype instanceof target;
        };
        ss2.isClass = function Type$isClass(type) {
          return type.__class == true || type === Array || type === Function || type === RegExp || type === String || type === Error || type === Object;
        };
        ss2.isEnum = function Type$isEnum(type) {
          return !!type.__enum;
        };
        ss2.isFlags = function Type$isFlags(type) {
          return type.__metadata && type.__metadata.enumFlags || false;
        };
        ss2.isInterface = function Type$isInterface(type) {
          return !!type.__interface;
        };
        ss2.safeCast = function ss$safeCast(instance, type) {
          if (type === true) return instance;
          else if (type === false) return null;
          else return ss2.isInstanceOfType(instance, type) ? instance : null;
        };
        ss2.cast = function ss$cast(instance, type) {
          ...
          throw new ss_InvalidCastException(
            "Cannot cast object to type " + ss2.getTypeFullName(type)
          );
        };
        ss2.getInstanceType = function ss$getInstanceType(instance) {
        ...
        ss2._getType = function(typeName, asm, re) {
          ...
          if (m) {
            ...
            switch (m[0]) {
              case "[":
                ...
                for (; ; ) {
                  re.exec(typeName);
                  var t = ss2._getType(typeName, global2, re);
                  if (!t) return null;
                  targs.push(t);
                  m = re.exec(typeName);
                  if (m[0] === "]") break;
          ...
          var t = ss2._getAssemblyType(asm, tname.trim());
          return targs.length ? ss2.makeGenericType(t, targs) : t;
        };
        ss2.getType = function ss$getType(typeName, asm) {
          return typeName ? ss2._getType(typeName, asm || global2) : null;
        };
        ss2.getDefaultValue = function ss$getDefaultValue(type) {
          if (typeof type.getDefaultValue === "function")
            return type.getDefaultValue();
          else if (type === Boolean) return false;
          else if (type === Date) return /* @__PURE__ */ new Date(0);
          else if (type === Number) return 0;
          return null;
        };
        ss2.createInstance = function ss$createInstance(type) {
        ...
        ss2.IFormattable = ss_IFormattable;
        ss2.initInterface(ss_IFormattable, ss2, { format: null });
        var ss_IComparable = function IComparable$() {
        };
        ss_IComparable.__typeName = "ss.IComparable";
        ss2.IComparable = ss_IComparable;
        ss2.initInterface(ss_IComparable, ss2, { compareTo: null });
        var ss_IEquatable = function IEquatable$() {
        };
        ss_IEquatable.__typeName = "ss.IEquatable";
        ss2.IEquatable = ss_IEquatable;
        ss2.initInterface(ss_IEquatable, ss2, { equalsT: null });
        ss2.isNullOrEmptyString = function ss$isNullOrEmptyString(s) {
          return !s || !s.length;
        };
        ...
        ss2.trimEndString = function ss$trimEndString(s, chars) {
          return s.replace(
            chars ? new RegExp("[" + String.fromCharCode.apply(null, chars) + "]+$") : /\s*$/,
            ""
          );
        };
        ss2.trimStartString = function ss$trimStartString(s, chars) {
          return s.replace(
            chars ? new RegExp("^[" + String.fromCharCode.apply(null, chars) + "]+") : /^\s*/,
            ""
          );
        };
        ss2.trimString = function ss$trimString(s, chars) {
          return ss2.trimStartString(ss2.trimEndString(s, chars), chars);
        };
        ss2.arrayClone = function ss$arrayClone(arr) {
          if (arr.length === 1) {
            return [arr[0]];
          } else {
        ...
        ss2._delegateContains = function ss$_delegateContains(targets, object, method) {
        ...
        ss2._mkdel = function ss$_mkdel(targets) {
        ...
        ss2.mkdel = function ss$mkdel(object, method) {
          if (!object) {
            return method;
          }
          return ss2._mkdel([object, method]);
        };
        ss2.delegateCombine = function ss$delegateCombine(delegate1, delegate2) {
          if (!delegate1) {
        ...
        ss2.delegateRemove = function ss$delegateRemove(delegate1, delegate2) {
        ...
        ss2.delegateEquals = function ss$delegateEquals(a, b) {
          if (a === b) return true;
        ...
        ss2.IEnumerator = ss_IEnumerator;
        ss2.initInterface(
          ss_IEnumerator,
          ss2,
        ...
        ss2.IEnumerable = ss_IEnumerable;
        ss2.initInterface(ss_IEnumerable, ss2, { getEnumerator: null });
        ss2.getEnumerator = function ss$getEnumerator(obj) {
        ...
        ss2.ICollection = ss_ICollection;
        ss2.initInterface(ss_ICollection, ss2, {
          get_count: null,
          add: null,
          clear: null,
          contains: null,
        ...
        ss2.count = function ss$count(obj) {
          return obj.get_count ? obj.get_count() : obj.length;
        };
        ss2.add = function ss$add(obj, item) {
          if (obj.add) obj.add(item);
          else if (ss2.isArray(obj)) obj.push(item);
          else throw new ss_NotSupportedException();
        };
        ss2.clear = function ss$clear(obj) {
          if (obj.clear) obj.clear();
          else if (ss2.isArray(obj)) obj.length = 0;
          else throw new ss_NotSupportedException();
        };
        ss2.remove = function ss$remove(obj, item) {
        ...
        ss2.contains = function ss$contains(obj, item) {
          if (obj.contains) return obj.contains(item);
          else return ss2.indexOf(obj, item) >= 0;
        };
        var ss_IEqualityComparer = function IEqualityComparer$() {
        };
        ss_IEqualityComparer.__typeName = "ss.IEqualityComparer";
        ss2.IEqualityComparer = ss_IEqualityComparer;
        ss2.initInterface(ss_IEqualityComparer, ss2, {
          areEqual: null,
        ...
        ss2.IComparer = ss_IComparer;
        ss2.initInterface(ss_IComparer, ss2, { compare: null });
        ss2.unbox = function ss$unbox(instance) {
          if (!ss2.isValue(instance))
        ...
        var ss_Nullable$1 = function Nullable$1$(T) {
          ...
          ss2.registerGenericClassInstance(
            $type,
            ss_Nullable$1,
            [T],
            {},
        ...
        ss2.Nullable$1 = ss_Nullable$1;
        ss2.initGenericClass(ss_Nullable$1, ss2, 1);
        ...
        ss_Nullable$1.lift = function Nullable$lift() {
          for (var i = 0; i < arguments.length; i++) {
            if (!ss2.isValue(arguments[i])) return null;
          }
        ...
        ss2.getItem = function ss$getItem(obj, index) {
          return obj.get_item ? obj.get_item(index) : obj[index];
        };
        ss2.setItem = function ss$setItem(obj, index, value) {
          obj.set_item ? obj.set_item(index, value) : obj[index] = value;
        };
        ss2.indexOf = function ss$indexOf(obj, item) {
        ...
        ss2.insert = function ss$insert(obj, index, item) {
          if (obj.insert) obj.insert(index, item);
          else if (ss2.isArray(obj)) obj.splice(index, 0, item);
          else throw new ss_NotSupportedException();
        };
        ss2.removeAt = function ss$removeAt(obj, index) {
          if (obj.removeAt) obj.removeAt(index);
          else if (ss2.isArray(obj)) obj.splice(index, 1);
          else throw new ss_NotSupportedException();
        };
        var ss_IDictionary = function IDictionary$() {
        };
        ss_IDictionary.__typeName = "ss.IDictionary";
        ss2.IDictionary = ss_IDictionary;
        ss2.initInterface(
          ss_IDictionary,
          ss2,
          {
        ...
        ss2.Int32 = ss_Int32;
        ss2.initClass(ss_Int32, ss2, {}, Object, [
          ss_IEquatable,
          ss_IComparable,
          ss_IFormattable
        ]);
        ...
        ss_Int32.div = function Int32$div(a, b) {
          if (!ss2.isValue(a) || !ss2.isValue(b)) return null;
        ...
        ss2.JsDate = ss_JsDate;
        ss2.initClass(ss_JsDate, ss2, {}, Object, [ss_IEquatable, ss_IComparable]);
        ...
        ss2.ArrayEnumerator = ss_ArrayEnumerator;
        ss2.initClass(
          ss_ArrayEnumerator,
          ss2,
          {
        ...
        ss2.ObjectEnumerator = ss_ObjectEnumerator;
        ss2.initClass(
          ss_ObjectEnumerator,
          ss2,
          {
        ...
        ss2.EqualityComparer = ss_EqualityComparer;
        ss2.initClass(
          ss_EqualityComparer,
          ss2,
          {
        ...
        ss_Comparer.def = new ss_Comparer(function Comparer$defaultCompare(a, b) {
          if (!ss2.isValue(a)) return !ss2.isValue(b) ? 0 : -1;
          else if (!ss2.isValue(b)) return 1;
          else return ss2.compare(a, b);
        });
        var ss_IDisposable = function IDisposable$() {
        };
        ss_IDisposable.__typeName = "ss.IDisposable";
        ss2.IDisposable = ss_IDisposable;
        ss2.initInterface(ss_IDisposable, ss2, { dispose: null });
        ...
        ss2.StringBuilder = ss_StringBuilder;
        ss2.initClass(ss_StringBuilder, ss2, {
        ...
        ss2.EventArgs = ss_EventArgs;
        ss2.initClass(ss_EventArgs, ss2, {});
        ...
        ss2.Exception = ss_Exception;
        ss2.initClass(ss_Exception, ss2, {
        ...
        ss2.NotImplementedException = ss_NotImplementedException;
        ss2.initClass(ss_NotImplementedException, ss2, {}, ss_Exception);
        ...
        ss2.NotSupportedException = ss_NotSupportedException;
        ss2.initClass(ss_NotSupportedException, ss2, {}, ss_Exception);
        var ss_AggregateException = function AggregateException$(message, innerExceptions) {
          this.innerExceptions = ss2.isValue(innerExceptions) ? ss2.arrayFromEnumerable(innerExceptions) : [];
          ss_Exception.call(
            this,
        ...
        ss2.AggregateException = ss_AggregateException;
        ss2.initClass(
          ...
          ss2,
          {
            flatten: function AggregateException$flatten() {
              ...
              for (var i = 0; i < this.innerExceptions.length; i++) {
                ...
                if (ss2.isInstanceOfType(e, ss_AggregateException)) {
        ...
        var ss_PromiseException = function PromiseException(args, message, innerException) {
          ss_Exception.call(
            this,
            message || (args.length && args[0] ? args[0].toString() : "An error occurred"),
            innerException
          );
          this.arguments = ss2.arrayClone(args);
        };
        ss_PromiseException.__typeName = "ss.PromiseException";
        ss2.PromiseException = ss_PromiseException;
        ss2.initClass(
          ss_PromiseException,
          ss2,
          {
        ...
        ss2.JsErrorException = ss_JsErrorException;
        ss2.initClass(
          ss_JsErrorException,
          ss2,
          {
        ...
        ss2.ArgumentException = ss_ArgumentException;
        ss2.initClass(ss_ArgumentException, ss2, {}, ss_Exception);
        ...
        ss2.ArgumentNullException = ss_ArgumentNullException;
        ss2.initClass(ss_ArgumentNullException, ss2, {}, ss_ArgumentException);
        ...
        ss2.ArgumentOutOfRangeException = ss_ArgumentOutOfRangeException;
        ss2.initClass(ss_ArgumentOutOfRangeException, ss2, {}, ss_ArgumentException);
        ...
        ss2.FormatException = ss_FormatException;
        ss2.initClass(ss_FormatException, ss2, {}, ss_Exception);
        ...
        ss2.DivideByZeroException = ss_DivideByZeroException;
        ss2.initClass(ss_DivideByZeroException, ss2, {}, ss_Exception);
        ...
        ss2.InvalidCastException = ss_InvalidCastException;
        ss2.initClass(ss_InvalidCastException, ss2, {}, ss_Exception);
        ...
        ss2.InvalidOperationException = ss_InvalidOperationException;
        ss2.initClass(ss_InvalidOperationException, ss2, {}, ss_Exception);
        ...
        ss2.NullReferenceException = ss_NullReferenceException;
        ss2.initClass(ss_NullReferenceException, ss2, {}, ss_Exception);
        ...
        ss2.KeyNotFoundException = ss_KeyNotFoundException;
        ss2.initClass(ss_KeyNotFoundException, ss2, {}, ss_Exception);
        ...
        ss2.AmbiguousMatchException = ss_AmbiguousMatchException;
        ss2.initClass(ss_AmbiguousMatchException, ss2, {}, ss_Exception);
        ...
        ss2.IteratorBlockEnumerable = ss_IteratorBlockEnumerable;
        ss2.initClass(
        ...
        ss2.IteratorBlockEnumerator = ss_IteratorBlockEnumerator;
        ss2.initClass(
        ...
        if (typeof global2.HTMLElement === "undefined") {
          global2.HTMLElement = Element;
        }
        if (typeof global2.MessageEvent === "undefined") {
          global2.MessageEvent = Event;
        }
      ...
      (function() {
        ...
        (function() {
          ...
          }
          {
            ...
            for (var k = 0; k < h.length && (ss.isNullOrUndefined(i) || ss.isNullOrUndefined(j)); ++k) {
              var l = h[k];
      ...
      (function() {
          ...
          return function() {
            ...
            if (ss.isNullOrUndefined(bj)) {
              throw q.createInternalError(
                "No creation function has been registered for interface type '" + bh + "'."
              );
            }
            var bk = bj();
            return bk;
        ...
        m.parseJSON = function(e) {
          ...
          if (m.$a.test(
            e.replace(m.$b, "@").replace(m.$c, "]").replace(m.$9, "")
          )) {
        ...
        q.createInternalError = function(e) {
          if (ss.isValue(e)) {
            return q.create(
              "internalError",
              "Internal error. Please contact Tableau support with the following information: " + e
            );
          } else {
            return q.create(
              "internalError",
        ...
        ss.initClass(n, a, {
          ...
          $0: function(e) {
            ...
            if (e.behavior === "automatic") {
              bm = tab.SheetSize.$ctor("automatic", void 0, void 0);
              ...
              bm = tab.SheetSize.$ctor("atmost", void 0, e.maxSize);
              ...
              bm = tab.SheetSize.$ctor("atleast", e.minSize, void 0);
          ...
          a,
          {
            ...
            $f: function(e, bm) {
              ...
              if (bn.storyPointId !== bm.storyPointId) {
                throw tab._TableauException.createInternalError(
                  "We should not be updating a story point where the IDs don't match. Existing storyPointID=" + bn.storyPointId + ", newStoryPointID=" + bm.storyPointId
                );
              }
        ...
        ss.initClass(u, a, {
          ...
          $0: function() {
            ...
            try {
              while (bo.moveNext()) {
                var bp = bo.current();
                if (bp.key !== "embed" && bp.key !== "height" && bp.key !== "width" && bp.key !== "device" && bp.key !== "autoSize" && bp.key !== "hideTabs" && bp.key !== "hideToolbar" && bp.key !== "onFirstInteractive" && bp.key !== "onFirstVizSizeKnown" && bp.key !== "toolbarPosition" && bp.key !== "instanceIdToClone" && bp.key !== "display_static_image") {
                  e.push("&");
        ...
        ss.initClass(
          ...
          a,
          {
            ...
            $B: function(e, bm, bn) {
              ...
              if (tab._Utility.isString(e) && (tab._jQueryShim.isArray(bm) || tab._Utility.isString(bm) || !tab.PublicEnums.isValidEnum(tab.ApiSelectionUpdateType).call(
                null,
                bm
              ))) {
          ...
          a,
          {
            ...
            $K: function() {
              ...
              throw tab._TableauException.create(
                ...
                "Viz resize limit hit. The calculated iframe size did not stabilize after " + bm + " resizes."
              );
            },
            ...
            addEventListener: function(e, bm) {
              var bn = {};
              if (!tab.PublicEnums.tryNormalizeEnum(tab.ApiTableauEventName).call(
                null,
                e,
                bn
              )) {
            ...
            $v: function() {
              window.setTimeout(ss.mkdel(this, this.$2), 3e3);
            },
            $6: function(e) {
...
export default require_tableau_api();
/*! Bundled license information:

tableau-api/index.js:
  (*! tableau-2.1.2 *)
  (*! tableau-2.2.1 *)
  (*! BEGIN MscorlibSlim *)
  (*! BEGIN CoreSlim *)
  ...
  (*! API *)
*/
//# sourceMappingURL=tableau-api.js.map
